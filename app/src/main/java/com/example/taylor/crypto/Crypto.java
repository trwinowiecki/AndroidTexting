...
import com.example.taylor.utils.Strings;
...
public class Crypto {
    public static void writePublicKeyToPreferences(String keyStr, byte[] key) {
        ...
        try {
            ...
            pemWriter.flush();
            pemWriter.close();
            Preferences.putString(keyStr, publicStringWriter.toString());
        } catch (IOException e) {
    ...
    public static void writePrivateKeyToPreferences(KeyPair key) {
        StringWriter publicStringWriter = new StringWriter();
        ...
        try {
            ...
            pemWriter.flush();
            pemWriter.close();
            Preferences.putString(Preferences.RSA_PRIVATE_KEY, publicStringWriter.toString());
        } catch (IOException e) {
            Log.e("RSA", e.getMessage());
            e.printStackTrace();
        }
