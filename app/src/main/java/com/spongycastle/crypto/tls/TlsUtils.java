...
public class TlsUtils
{
    ...
    static void validateKeyUsage(com.spongycastle.asn1.x509.Certificate c, int keyUsageBits)
        throws IOException
    {
        ...
        throws IOException
    {
        ...
        com.spongycastle.asn1.x509.Certificate x509Cert = clientCertificate.getCertificateAt(0);
