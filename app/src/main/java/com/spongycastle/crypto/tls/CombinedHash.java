    ...
    implements TlsHandshakeHash
{
    ...
    /**
     * @see com.spongycastle.crypto.Digest#getAlgorithmName()
     */
    ...
    /**
     * @see com.spongycastle.crypto.Digest#getDigestSize()
     */
    ...
    /**
     * @see com.spongycastle.crypto.Digest#update(byte)
     */
    ...
    /**
     * @see com.spongycastle.crypto.Digest#update(byte[], int, int)
     */
    ...
    /**
     * @see com.spongycastle.crypto.Digest#doFinal(byte[], int)
     */
    ...
    /**
     * @see com.spongycastle.crypto.Digest#reset()
     */
    public void reset()
    {
        md5.reset();
