package com.spongycastle.crypto.agreement.jpake;
...
public class JPAKERound3Payload
{
     ...
     *
     * @see JPAKEUtil#calculateMacTag(String, String, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, com.spongycastle.crypto.Digest)
     */
