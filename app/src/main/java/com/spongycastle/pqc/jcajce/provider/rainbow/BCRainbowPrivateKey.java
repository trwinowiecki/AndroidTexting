package com.spongycastle.pqc.jcajce.provider.rainbow;
...
import com.spongycastle.pqc.asn1.PQCObjectIdentifiers;
import com.spongycastle.pqc.asn1.RainbowPrivateKey;
import com.spongycastle.pqc.crypto.rainbow.Layer;
import com.spongycastle.pqc.crypto.rainbow.RainbowPrivateKeyParameters;
import com.spongycastle.pqc.crypto.rainbow.util.RainbowUtil;
import com.spongycastle.pqc.jcajce.spec.RainbowPrivateKeySpec;
    ...
    implements PrivateKey
{
    ...
    public int hashCode()
    {
        ...
        hash = hash * 37 + com.spongycastle.util.Arrays.hashCode(A1inv);
        hash = hash * 37 + com.spongycastle.util.Arrays.hashCode(b1);
        hash = hash * 37 + com.spongycastle.util.Arrays.hashCode(A2inv);
        hash = hash * 37 + com.spongycastle.util.Arrays.hashCode(b2);
        hash = hash * 37 + com.spongycastle.util.Arrays.hashCode(vi);
