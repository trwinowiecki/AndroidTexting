package com.spongycastle.pqc.jcajce.provider;
...
import com.spongycastle.pqc.jcajce.provider.rainbow.RainbowKeyFactorySpi;

public class Rainbow
{
    private static final String PREFIX = "com.spongycastle.pqc.jcajce.provider" + ".rainbow.";
