 ...
 *
 * @see com.spongycastle.pqc.jcajce.provider.mceliece.BCMcElieceCCA2PublicKey
 */
    ...
    implements KeySpec
{
    ...
    /**
     * Constructor (used by {@link com.spongycastle.pqc.jcajce.provider.mceliece.McElieceKeyFactorySpi}).
     *
     * @param n         length of the code
