...
import com.spongycastle.asn1.pkcs.RSAPublicKey;
import com.spongycastle.asn1.x509.AlgorithmIdentifier;
import com.spongycastle.asn1.x509.DSAParameter;
...
import com.spongycastle.cert.X509AttributeCertificateHolder;
...
import com.spongycastle.pkcs.PKCS8EncryptedPrivateKeyInfo;
import com.spongycastle.util.encoders.Hex;
import com.spongycastle.util.io.pem.PemHeader;
import com.spongycastle.util.io.pem.PemObject;
import com.spongycastle.util.io.pem.PemObjectParser;
import com.spongycastle.util.io.pem.PemReader;
        ...
        implements PEMKeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                com.spongycastle.asn1.sec.ECPrivateKey pKey = com.spongycastle.asn1.sec.ECPrivateKey.getInstance(seq);
        ...
        implements PEMKeyPairParser
    {
            ...
            throws IOException
        {
            try
            {
                ...
                com.spongycastle.asn1.pkcs.RSAPrivateKey keyStruct = com.spongycastle.asn1.pkcs.RSAPrivateKey.getInstance(seq);
