 ...
 * {@link com.spongycastle.x509.X509Store} SPI implementation for certificate
 * pairs.
 *
 * @see com.spongycastle.x509.X509Store
 * @see com.spongycastle.x509.X509CertificatePair
 */
public class X509StoreCertPairCollection extends X509StoreSpi
{
     ...
     * {@link com.spongycastle.x509.X509CertificatePair}s. The selector must be
     * a {@link com.spongycastle.x509.X509CertPairStoreSelector} to select
     * certificate pairs.
     * </p>
