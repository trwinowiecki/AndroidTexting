...
import com.spongycastle.asn1.pkcs.SignedData;
import com.spongycastle.x509.X509StreamParserSpi;
import com.spongycastle.x509.util.StreamParsingException;
    ...
    extends X509StreamParserSpi
{
        ...
        throws IOException, CertificateParsingException
    {
        ...
        return new X509CertificateObject(
                            com.spongycastle.asn1.x509.Certificate.getInstance(seq));
    }
        ...
        throws CertificateParsingException
    {
        if (sData != null)
        {
            while (sDataObjectCount < sData.size())
            {
                ...
                {
                   return new X509CertificateObject(
                                    com.spongycastle.asn1.x509.Certificate.getInstance(obj));
                }
            }
        }
