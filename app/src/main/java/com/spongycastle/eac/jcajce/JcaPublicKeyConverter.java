package com.spongycastle.eac.jcajce;
...
import com.spongycastle.asn1.eac.ECDSAPublicKey;
import com.spongycastle.asn1.eac.PublicKeyDataObject;
import com.spongycastle.asn1.eac.RSAPublicKey;
import com.spongycastle.eac.EACException;
...
public class JcaPublicKeyConverter
{
    ...
    private static com.spongycastle.math.ec.ECPoint convertPoint(
        ECCurve curve,
