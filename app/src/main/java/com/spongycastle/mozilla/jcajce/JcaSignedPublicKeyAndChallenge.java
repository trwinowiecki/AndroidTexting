package com.spongycastle.mozilla.jcajce;
...
import com.spongycastle.mozilla.SignedPublicKeyAndChallenge;
    ...
    extends SignedPublicKeyAndChallenge
{
    ...
    private JcaSignedPublicKeyAndChallenge(com.spongycastle.asn1.mozilla.SignedPublicKeyAndChallenge struct, JcaJceHelper helper)
    {
        super(struct);
        this.helper = helper;
    }
