package com.spongycastle.mozilla;
...
import com.spongycastle.asn1.mozilla.PublicKeyAndChallenge;
...
{
    protected final com.spongycastle.asn1.mozilla.SignedPublicKeyAndChallenge          spkacSeq;

    public SignedPublicKeyAndChallenge(byte[] bytes)
    {
        spkacSeq = com.spongycastle.asn1.mozilla.SignedPublicKeyAndChallenge.getInstance(bytes);
    }

    protected SignedPublicKeyAndChallenge(com.spongycastle.asn1.mozilla.SignedPublicKeyAndChallenge struct)
    {
     ...
     */
    public com.spongycastle.asn1.mozilla.SignedPublicKeyAndChallenge toASN1Structure()
    {
         return spkacSeq;
    }
