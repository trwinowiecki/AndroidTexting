...
import com.spongycastle.jcajce.provider.asymmetric.gost.KeyFactorySpi;
...
public class GOST
{
    private static final String PREFIX = "com.spongycastle.jcajce.provider.asymmetric" + ".gost.";
