...
import com.spongycastle.jcajce.provider.asymmetric.dstu.KeyFactorySpi;
...
{
    private static final String PREFIX = "com.spongycastle.jcajce.provider.asymmetric" + ".dstu.";
