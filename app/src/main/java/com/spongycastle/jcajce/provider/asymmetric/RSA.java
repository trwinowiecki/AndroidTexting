...
import com.spongycastle.jcajce.provider.asymmetric.rsa.KeyFactorySpi;
...
public class RSA
{
    private static final String PREFIX = "com.spongycastle.jcajce.provider.asymmetric" + ".rsa.";
