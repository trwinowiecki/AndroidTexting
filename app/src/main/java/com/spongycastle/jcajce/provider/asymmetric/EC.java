...
import com.spongycastle.jcajce.provider.asymmetric.ec.KeyFactorySpi;
...
import com.spongycastle.util.Properties;

public class EC
{
    private static final String PREFIX = "com.spongycastle.jcajce.provider.asymmetric" + ".ec.";
        ...
        extends AsymmetricAlgorithmProvider
    {
        ...
        public void configure(ConfigurableProvider provider)
        {
            ...
            if (!Properties.isOverrideSet("com.spongycastle.ec.disable_mqv"))
            {
