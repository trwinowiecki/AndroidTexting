...
public class EC5Util
{
    ...
    public static com.spongycastle.jce.spec.ECParameterSpec convertSpec(
        ECParameterSpec ecSpec,
        boolean withCompression)
    {
        ECCurve curve = convertCurve(ecSpec.getCurve());

        return new com.spongycastle.jce.spec.ECParameterSpec(
            curve,
    ...
    public static com.spongycastle.math.ec.ECPoint convertPoint(
        ECParameterSpec ecSpec,
        ECPoint point,
        boolean withCompression)
    {
