package com.spongycastle.jcajce.provider.keystore.pkcs12;
...
import com.spongycastle.asn1.BEROutputStream;
import com.spongycastle.asn1.DERBMPString;
...
import com.spongycastle.asn1.cryptopro.CryptoProObjectIdentifiers;
...
import com.spongycastle.asn1.pkcs.AuthenticatedSafe;
import com.spongycastle.asn1.pkcs.CertBag;
import com.spongycastle.asn1.pkcs.ContentInfo;
import com.spongycastle.asn1.pkcs.EncryptedData;
...
import com.spongycastle.asn1.pkcs.Pfx;
import com.spongycastle.asn1.pkcs.SafeBag;
import com.spongycastle.asn1.util.ASN1Dump;
...
import com.spongycastle.asn1.x509.SubjectKeyIdentifier;
...
import com.spongycastle.jcajce.PKCS12StoreParameter;
...
import com.spongycastle.jce.interfaces.BCKeyStore;
import com.spongycastle.jce.interfaces.PKCS12BagAttributeCarrier;
import com.spongycastle.jce.provider.BouncyCastleProvider;
import com.spongycastle.jce.provider.JDKPKCS12StoreParameter;
    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore
{
            ...
            for (int i = 0; i != c.length; i++)
            {
                if (c[i].getContentType().equals(data))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            com.spongycastle.asn1.pkcs.EncryptedPrivateKeyInfo eIn = com.spongycastle.asn1.pkcs.EncryptedPrivateKeyInfo.getInstance(b.getBagValue());
                ...
                else if (c[i].getContentType().equals(encryptedData))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            com.spongycastle.asn1.pkcs.PrivateKeyInfo kInfo = com.spongycastle.asn1.pkcs.PrivateKeyInfo.getInstance(b.getBagValue());
        ...
        throws IOException
    {
        ...
        while (ks.hasMoreElements())
        {
            ...
            com.spongycastle.asn1.pkcs.EncryptedPrivateKeyInfo kInfo = new com.spongycastle.asn1.pkcs.EncryptedPrivateKeyInfo(kAlgId, kBytes);
