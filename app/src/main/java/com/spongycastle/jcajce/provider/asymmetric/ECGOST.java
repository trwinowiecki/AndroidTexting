...
import com.spongycastle.jcajce.provider.asymmetric.ecgost.KeyFactorySpi;
...
public class ECGOST
{
    private static final String PREFIX = "com.spongycastle.jcajce.provider.asymmetric" + ".ecgost.";
