...
import com.spongycastle.asn1.bc.BCObjectIdentifiers;
import com.spongycastle.asn1.cms.CCMParameters;
...
import com.spongycastle.crypto.engines.RFC5649WrapEngine;
...
import com.spongycastle.jcajce.provider.symmetric.util.BaseAlgorithmParameters;
...
import com.spongycastle.jcajce.provider.symmetric.util.PBESecretKeyFactory;
...
public final class AES
{
        ...
        extends BaseMac
    {
        public Poly1305()
        {
            super(new com.spongycastle.crypto.macs.Poly1305(new AESFastEngine()));
        }
    }
