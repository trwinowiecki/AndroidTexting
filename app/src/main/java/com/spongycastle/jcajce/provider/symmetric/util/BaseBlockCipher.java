...
import com.spongycastle.asn1.cms.GCMParameters;
...
import com.spongycastle.crypto.DataLengthException;
import com.spongycastle.crypto.InvalidCipherTextException;
import com.spongycastle.crypto.OutputLengthException;
import com.spongycastle.crypto.modes.AEADBlockCipher;
import com.spongycastle.crypto.modes.CBCBlockCipher;
import com.spongycastle.crypto.modes.CCMBlockCipher;
import com.spongycastle.crypto.modes.CFBBlockCipher;
import com.spongycastle.crypto.modes.CTSBlockCipher;
import com.spongycastle.crypto.modes.EAXBlockCipher;
import com.spongycastle.crypto.modes.GCFBBlockCipher;
import com.spongycastle.crypto.modes.GCMBlockCipher;
import com.spongycastle.crypto.modes.GOFBBlockCipher;
import com.spongycastle.crypto.modes.OCBBlockCipher;
import com.spongycastle.crypto.modes.OFBBlockCipher;
import com.spongycastle.crypto.modes.OpenPGPCFBBlockCipher;
import com.spongycastle.crypto.modes.PGPCFBBlockCipher;
import com.spongycastle.crypto.modes.SICBlockCipher;
import com.spongycastle.crypto.paddings.BlockCipherPadding;
import com.spongycastle.crypto.paddings.ISO10126d2Padding;
import com.spongycastle.crypto.paddings.ISO7816d4Padding;
import com.spongycastle.crypto.paddings.PaddedBufferedBlockCipher;
import com.spongycastle.crypto.paddings.TBCPadding;
import com.spongycastle.crypto.paddings.X923Padding;
import com.spongycastle.crypto.paddings.ZeroBytePadding;
import com.spongycastle.crypto.params.AEADParameters;
...
import com.spongycastle.crypto.params.ParametersWithSBox;
import com.spongycastle.crypto.params.RC2Parameters;
import com.spongycastle.crypto.params.RC5Parameters;
import com.spongycastle.jcajce.PBKDF1Key;
import com.spongycastle.jcajce.PBKDF1KeyWithParameters;
import com.spongycastle.jcajce.PKCS12Key;
import com.spongycastle.jcajce.PKCS12KeyWithParameters;
import com.spongycastle.jcajce.spec.GOST28147ParameterSpec;
import com.spongycastle.jcajce.spec.RepeatedSecretKeySpec;
    ...
    implements PBE
{
    ...
    protected BaseBlockCipher(
        com.spongycastle.crypto.BlockCipher engine,
        int ivLength)
    {
        baseEngine = engine;
    ...
    static private interface GenericBlockCipher
    {
        ...
        public com.spongycastle.crypto.BlockCipher getUnderlyingCipher();
        ...
        implements GenericBlockCipher
    {
        ...
        BufferedGenericBlockCipher(com.spongycastle.crypto.BlockCipher cipher)
        {
            this.cipher = new PaddedBufferedBlockCipher(cipher);
        }

        BufferedGenericBlockCipher(com.spongycastle.crypto.BlockCipher cipher, BlockCipherPadding padding)
        {
