...
import com.spongycastle.asn1.anssi.ANSSINamedCurves;
...
import com.spongycastle.asn1.sec.SECNamedCurves;
import com.spongycastle.asn1.teletrust.TeleTrusTNamedCurves;
import com.spongycastle.asn1.x509.SubjectPublicKeyInfo;
import com.spongycastle.asn1.x9.ECNamedCurveTable;
import com.spongycastle.asn1.x9.X962NamedCurves;
...
import com.spongycastle.jcajce.provider.asymmetric.ec.BCECPublicKey;
...
public class ECUtil
{
        ...
        ECParameterSpec ecParameterSpec)
    {
        for (Enumeration names = ECNamedCurveTable.getNames(); names.hasMoreElements();)
        {
            ...
            {
                return com.spongycastle.asn1.x9.ECNamedCurveTable.getOID(name);
            }
        }
