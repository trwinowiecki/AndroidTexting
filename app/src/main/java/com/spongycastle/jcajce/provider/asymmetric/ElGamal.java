...
import com.spongycastle.jcajce.provider.asymmetric.elgamal.KeyFactorySpi;
...
{
    private static final String PREFIX = "com.spongycastle.jcajce.provider.asymmetric" + ".elgamal.";
