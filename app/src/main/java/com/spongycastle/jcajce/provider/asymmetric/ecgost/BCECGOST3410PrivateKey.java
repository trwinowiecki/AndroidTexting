...
import com.spongycastle.asn1.cryptopro.GOST3410PublicKeyAlgParameters;
...
import com.spongycastle.jcajce.provider.asymmetric.util.PKCS12BagAttributeCarrierImpl;
import com.spongycastle.jce.ECGOST3410NamedCurveTable;
...
public class BCECGOST3410PrivateKey
    implements ECPrivateKey, com.spongycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder
{
    ...
    public BCECGOST3410PrivateKey(
        com.spongycastle.jce.spec.ECPrivateKeySpec spec)
    {
        this.d = spec.getD();
        ...
        throws IOException
    {
        ...
        else
        {
            ...
            {
                com.spongycastle.asn1.sec.ECPrivateKey ec = com.spongycastle.asn1.sec.ECPrivateKey.getInstance(privKey);
    ...
    public byte[] getEncoded()
    {
        ...
        else
        {
            ...
            PrivateKeyInfo info;
            com.spongycastle.asn1.sec.ECPrivateKey keyStructure;

            if (publicKey != null)
            {
                keyStructure = new com.spongycastle.asn1.sec.ECPrivateKey(orderBitLength, this.getS(), publicKey, params);
            }
            else
            {
                keyStructure = new com.spongycastle.asn1.sec.ECPrivateKey(orderBitLength, this.getS(), params);
            }
