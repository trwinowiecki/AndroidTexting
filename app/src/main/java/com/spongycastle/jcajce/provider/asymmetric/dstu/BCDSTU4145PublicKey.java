package com.spongycastle.jcajce.provider.asymmetric.dstu;
...
import com.spongycastle.asn1.ua.DSTU4145BinaryField;
import com.spongycastle.asn1.ua.DSTU4145ECBinary;
import com.spongycastle.asn1.ua.DSTU4145NamedCurves;
import com.spongycastle.asn1.ua.DSTU4145Params;
import com.spongycastle.asn1.ua.DSTU4145PointEncoder;
import com.spongycastle.asn1.ua.UAObjectIdentifiers;
import com.spongycastle.asn1.x509.AlgorithmIdentifier;
import com.spongycastle.asn1.x509.SubjectPublicKeyInfo;
import com.spongycastle.asn1.x9.X962Parameters;
...
import com.spongycastle.jcajce.provider.asymmetric.util.KeyUtil;
import com.spongycastle.jce.interfaces.ECPointEncoder;
import com.spongycastle.jce.provider.BouncyCastleProvider;
import com.spongycastle.jce.spec.ECNamedCurveParameterSpec;
...
public class BCDSTU4145PublicKey
    implements ECPublicKey, com.spongycastle.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    private transient com.spongycastle.math.ec.ECPoint q;
    ...
    public BCDSTU4145PublicKey(
        com.spongycastle.jce.spec.ECPublicKeySpec spec)
    {
        this.q = spec.getQ();
        ...
        else
        {
            if (q.getCurve() == null)
            {
                com.spongycastle.jce.spec.ECParameterSpec s = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();
    ...
    public BCDSTU4145PublicKey(
        String algorithm,
        ECPublicKeyParameters params,
        com.spongycastle.jce.spec.ECParameterSpec spec)
    {
        ECDomainParameters dp = params.getParameters();
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo info)
    {
        ...
        com.spongycastle.jce.spec.ECParameterSpec spec = null;
        ...
        else
        {
            ...
            spec = new com.spongycastle.jce.spec.ECParameterSpec(curve, DSTU4145PointEncoder.decodePoint(curve, g_bytes), binary.getN());
        }
    ...
    public com.spongycastle.jce.spec.ECParameterSpec getParameters()
    {
    ...
    public com.spongycastle.math.ec.ECPoint getQ()
    {
        if (ecSpec == null)
        {
    ...
    public com.spongycastle.math.ec.ECPoint engineGetQ()
    {
        return q;
    }

    com.spongycastle.jce.spec.ECParameterSpec engineGetSpec()
    {
        if (ecSpec != null)
        {
            return EC5Util.convertSpec(ecSpec, withCompression);
