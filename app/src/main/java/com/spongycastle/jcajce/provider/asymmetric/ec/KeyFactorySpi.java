...
import com.spongycastle.jcajce.provider.asymmetric.util.BaseKeyFactorySpi;
...
import com.spongycastle.jce.spec.ECPrivateKeySpec;
import com.spongycastle.jce.spec.ECPublicKeySpec;
    ...
    implements AsymmetricKeyInfoConverter
{
    ...
    throws InvalidKeySpecException
    {
       ...
       else if (spec.isAssignableFrom(com.spongycastle.jce.spec.ECPublicKeySpec.class) && key instanceof ECPublicKey)
       {
           ECPublicKey k = (ECPublicKey)key;
           if (k.getParams() != null)
           {
               return new com.spongycastle.jce.spec.ECPublicKeySpec(EC5Util.convertPoint(k.getParams(), k.getW(), false), EC5Util.convertSpec(k.getParams(), false));
           }
           else
           {
               ECParameterSpec implicitSpec = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();

               return new com.spongycastle.jce.spec.ECPublicKeySpec(EC5Util.convertPoint(k.getParams(), k.getW(), false), implicitSpec);
           }
       }
       else if (spec.isAssignableFrom(com.spongycastle.jce.spec.ECPrivateKeySpec.class) && key instanceof ECPrivateKey)
       {
           ECPrivateKey k = (ECPrivateKey)key;

           if (k.getParams() != null)
           {
               return new com.spongycastle.jce.spec.ECPrivateKeySpec(k.getS(), EC5Util.convertSpec(k.getParams(), false));
           }
           else
           {
               ECParameterSpec implicitSpec = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();

               return new com.spongycastle.jce.spec.ECPrivateKeySpec(k.getS(), implicitSpec);
           }
       }
