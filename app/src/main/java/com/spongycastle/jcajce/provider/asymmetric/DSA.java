...
import com.spongycastle.jcajce.provider.asymmetric.dsa.DSAUtil;
import com.spongycastle.jcajce.provider.asymmetric.dsa.KeyFactorySpi;
...
public class DSA
{
    private static final String PREFIX = "com.spongycastle.jcajce.provider.asymmetric" + ".dsa.";
