package com.spongycastle.jcajce.provider.asymmetric.dsa;
...
import com.spongycastle.crypto.digests.NullDigest;
    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers
{
        ...
        extends DSASigner
    {
        public stdDSA()
        {
            super(new SHA1Digest(), new com.spongycastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public detDSA()
        {
            super(new SHA1Digest(), new com.spongycastle.crypto.signers.DSASigner(new HMacDSAKCalculator(new SHA1Digest())));
        }
    }
        ...
        extends DSASigner
    {
        public dsa224()
        {
            super(new SHA224Digest(), new com.spongycastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public detDSA224()
        {
            super(new SHA224Digest(), new com.spongycastle.crypto.signers.DSASigner(new HMacDSAKCalculator(new SHA224Digest())));
        }
    }
        ...
        extends DSASigner
    {
        public dsa256()
        {
            super(new SHA256Digest(), new com.spongycastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public detDSA256()
        {
            super(new SHA256Digest(), new com.spongycastle.crypto.signers.DSASigner(new HMacDSAKCalculator(new SHA256Digest())));
        }
    }
        ...
        extends DSASigner
    {
        public dsa384()
        {
            super(new SHA384Digest(), new com.spongycastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public detDSA384()
        {
            super(new SHA384Digest(), new com.spongycastle.crypto.signers.DSASigner(new HMacDSAKCalculator(new SHA384Digest())));
        }
    }
        ...
        extends DSASigner
    {
        public dsa512()
        {
            super(new SHA512Digest(), new com.spongycastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public detDSA512()
        {
            super(new SHA512Digest(), new com.spongycastle.crypto.signers.DSASigner(new HMacDSAKCalculator(new SHA512Digest())));
        }
    }
        ...
        extends DSASigner
    {
        public noneDSA()
        {
            super(new NullDigest(), new com.spongycastle.crypto.signers.DSASigner());
        }
    }
}
